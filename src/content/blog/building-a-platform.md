...
---
<!-- @generated by scripts/sync-content.mjs from writeups/platform-engineering/building-a-platform.md — edit the source, not this file -->
...
This is the type-vs-behavior split from the Kubernetes core: **the type is the contract; the behavior comes later** (`../../reference/kubernetes/04-advanced-development/crds/crds.md`).
...
| Guardrail | Tools |
|---|---|
| Admission policy (validate/mutate requests) | OPA Gatekeeper, Kyverno, CEL `ValidatingAdmissionPolicy` (in-tree, no webhook), custom admission webhooks (`../../reference/kubernetes/04-advanced-development/admission-webhooks/admission-webhooks.md`) |
