...
featured: false
---
<!-- @generated by scripts/sync-content.mjs from writeups/platform-engineering/kratix.md — edit the source, not this file -->
...
Nested Promises transform the central team from a **bottleneck into an enabler** - the org-level shift covered in depth in [From Ticket Queue to Federated Product](/blog/platform-engineering). In Kratix terms specifically:
